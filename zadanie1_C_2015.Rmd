...
```{r}
zb_trening <- window(szereg1, end = c(2012,12))
zb_test <- window(szereg1, start = c(2013,01))
...
```{r}
train_BC <- BoxCox(zb_trening, lambda)
test_BC <- BoxCox(zb_test, lambda)
